        ...
        <div className="w-[100vw] h-[100vh] font-mono bg-gradient-to-br from-emerald-50 to-teal-100 text-gray-800 flex flex-col">
            <div className="container mx-auto max-w-3xl py-6 flex flex-col justify-center items-center">
                ...
                <div className="rounded-3xl text-white bg-white shadow-xl flex flex-col p-8 h-[50vh] w-full max-w-md justify-around text-center space-y-6 my-10">
                    <input value={form.site} onChange={handleChange} className="rounded-4xl border border-gray-300 bg-emerald-50 text-black text-lg placeholder-gray-500 px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" type="text" name="site" placeholder="Enter Website URL"/>
                    <input value={form.username} onChange={handleChange} className="rounded-4xl border border-gray-300 bg-emerald-50 text-black text-lg placeholder-gray-500 px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" type="text" name="username" placeholder="Enter Username"/>
